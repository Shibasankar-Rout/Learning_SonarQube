...
COMMAND_LINE="$JAVA_CMD $XMS $XMX $HAZELCAST_ADDITIONAL -jar $LIB_DIR/sonar-application-25.8.0.112029.jar"
    ...
    then
        ...
        then
            ...
            then
                ...
                pidtest=`$PSEXE -p $pid | grep "sonar-application-25.8.0.112029.jar" | tail -1`
                if [ "X$pidtest" = "X" ]
                then
...
forcestopit() {
    ...
    then
      ...
      ${JAVA_CMD} -jar "lib/sonar-shutdowner-25.8.0.112029.jar"
